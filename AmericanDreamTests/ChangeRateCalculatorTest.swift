...
final class ChangeRateCalculatorTest: XCTestCase {
    ...
    override func setUp() {
        ...
        sut = ChangeRateCalculator(
            client:HTTPClientSpy(session: session),
...
//        URLProtocolStub.testErrorURLs = [:]
    ...
    func testWrongDataReturnsDecodingError() async {
        //Given
//        URLProtocolStub.testURLs = [url: Data("Wrong data".utf8)]
        ...
        //When
        Task.init {
            await sut.calculate(amount: 10.0) { result in
                //Then
...
//    func testInvalidDataReturnsMissingCurrencyError() async {
//        //Given
...
//    }
//
//    func testNetworkErrorReturnsGenericError() async {
//        //Given
...
//    }
//
//    func testCorrectDataReturnsConvertedAmountAndSaveInCache() async {
//        //Given
...
//
//        //When
//        await sut.calculate(amount: amount) { result in
//            //Then get result
...
//    }
//
//    func testCorrectDataReturnsConvertedAmountFromCache() async {
//        //Given
//        guard let jsonData = readLocalJSONFile(forName: "valid-rates") else { return XCTFail("file not found") }
//        URLProtocolStub.testURLs = [url: jsonData]
//        let amount = 10.0
